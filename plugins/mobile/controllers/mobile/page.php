...
class Page_Controller extends Mobile_Controller {
    ...
    public function index($page_id = 1)
    {
        ...
        $this->template->content = new View('mobile/page');
        ...
        $this->template->header->action_name = Kohana::lang("ui_main.".$page->page_title);
    }
