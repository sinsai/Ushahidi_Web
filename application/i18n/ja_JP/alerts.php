<?php
	...
	'verification_request' => 'もしくは、以下の承認コードを確認画面で登録してください。(携帯電話のメールアドレスを登録した場合等)',
	'go_to_confirm_view' => '確認画面を閉じた方はこちらにアクセスしてください。',
	...
	'verify_code' => 'あなたがリクエスト承認しない限り、この場所でのアラートを受信が出来ません。携帯電話のメールアドレスを登録した場合は、メールに記載されている承認コードをこの画面から入力して、承認してください。',
	);
?>
